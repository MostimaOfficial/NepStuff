...
import com.nepjr.misc.Stopwatch;
...
public abstract class TileEntityGeneratorBase extends TileBase implements ITickable {
    ...
    protected Stopwatch offTracker = new Stopwatch();
    ...
    private void updateCheck() {
        ...
        if (sendUpdatePacket) {
            ...
            ExNetDis.dispatchMachineUpdate(this);
        }
    }
