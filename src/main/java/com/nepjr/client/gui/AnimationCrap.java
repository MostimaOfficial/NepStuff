...
import com.nepjr.client.gui.MoreAnimationCrap.AnimationDirection;
...
public abstract class AnimationCrap extends GuiContainer {

    private Set<MoreAnimationCrap> drawableElements = new HashSet<>();
    private ResourceLocation BACKGROUND_TEX;

    public AnimationCrap(Container container) {
        super(container);
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        for (MoreAnimationCrap drawableGuiElement : drawableElements) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for (MoreAnimationCrap drawableElement : drawableElements) {
            try {
    ...
    protected void addDrawable(MoreAnimationCrap element) {
    ...
    protected static class DrawableBuilder {
        ...
        public MoreAnimationCrap build() {
            return new MoreAnimationCrap(parent, spriteLocation, sprite, location, animationDirection, animationSupplier, renderPredicate, tooltipSupplier);
        }
    }
}